    ...
    ListView {
        ...
        header: Item {
            ...
            Rectangle {
                ...
                color: {
                    if (Utils.currentDropTarget === parentDirItem) {
        ...
        delegate: Item {
            ...
            ContextMenu.menu: ItemContextMenu {
                ...
                onRenameClicked: scrollView.requestRename(contextMenu.itemPath, contextMenu.itemName)
                onDeleteClicked: scrollView.requestDelete(contextMenu.itemPath, contextMenu.itemIsDir)
            }
                ...
                DragHandler {
                    ...
                    onActiveChanged: {
                        if (active) {
                            ...
                            scrollView.setDragIndicatorText("Move " + delegateRoot.model.name)
                            scrollView.setDragIndicatorVisible(true)
                        } else {
                            scrollView.setDragIndicatorVisible(false)
                    ...
                    onCentroidChanged: {
                        if (active) {
                            ...
                            scrollView.setDragIndicatorX(globalPos.x + 10)
                            scrollView.setDragIndicatorY(globalPos.y + 10)
